...
const AddHouse = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        `https://backend.kejaspace.com/profile/addhouse/${propertyId}`,
        houseData,
        {
          headers: {
            authorization: token,
      ...
      .catch((error) => {
        ...
        ); // Added logging for error during submission
        ...
        <form className="register-form" onSubmit={handleSubmit}>
          ...
          <div className="p-2">
            ...
            <div className="mb-3">
              ...
              <input
                name="water"
                value={houseData.amenities.water.pricePerUnit}
                onChange={handleAmenityChange}
                type="number"
                className="form-control"
                id="water"
            ...
            <div className="mb-3">
              ...
              <input
                ...
                value={houseData.amenities.garbageCollection.pricePerMonth}
                onChange={handleAmenityChange}
                type="number"
                className="form-control"
            ...
            <div className="mb-3">
              <label htmlFor="description" className="form-label">
                Description of the Uploaded Unit
              </label>
              <textarea
                name="description"
